    ...
    with tf.control_dependencies([shape_assert]):
      with tf.variable_scope('InceptionV2',
        ...
        with _batch_norm_arg_scope([slim.conv2d, slim.separable_conv2d],
          ...
          _, activations, weights_camera, weights_gated, weights_lidar = inception_v2.inception_v2_base(
              preprocessed_inputs, preprocessed_gated, preprocessed_lidar,
              final_endpoint='Mixed_4d',
              min_depth=self._min_depth,
              depth_multiplier=self._depth_multiplier,
              scope=scope)

    return activations['Mixed_4d'], activations, weights_camera, weights_gated, weights_lidar
