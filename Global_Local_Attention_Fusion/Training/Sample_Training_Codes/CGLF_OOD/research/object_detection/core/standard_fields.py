...
class InputDataFields(object):
  ...
  original_gated = 'original_gated' # gated
  original_lidar = 'original_lidar' # lidar
  original_image_spatial_shape = 'original_image_spatial_shape'
  original_gated_spatial_shape = 'original_gated_spatial_shape' # gated
  original_lidar_spatial_shape = 'original_lidar_spatial_shape' # lidar
  key = 'key'
  source_id = 'source_id'
  filename = 'filename'
...
class TfExampleFields(object):
  ...
  gated_encoded = 'gated/encoded' # gated
  lidar_encoded = 'lidar/encoded' # lidar
...
SEQUENCE_FIELDS = [InputDataFields.image,
                   InputDataFields.gated, # gated
                   InputDataFields.lidar, # lidar
