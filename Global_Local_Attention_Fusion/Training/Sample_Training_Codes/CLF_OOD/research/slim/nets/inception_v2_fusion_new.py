...
def inception_v2_base(inputs_camera, inputs_gated,
  ...
  with tf.variable_scope(scope, 'InceptionV2', [inputs_camera, inputs_gated]):
    with slim.arg_scope(
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0_camera = slim.conv2d(net, depth(64), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
        ...
        with tf.variable_scope('Branch_2'):
          ...
          branch_2_camera = slim.conv2d(branch_2_camera, depth(96), [3, 3],
                                 scope='Conv2d_0c_3x3')
        with tf.variable_scope('Branch_3'):
          branch_3_camera = slim.avg_pool2d(net, [3, 3], scope='AvgPool_0a_3x3')
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('Branch_1'):
          branch_1_camera = slim.conv2d(
              ...
              scope='Conv2d_0a_1x1')
          branch_1_camera = slim.conv2d(
              branch_1_camera, depth(96), [3, 3], scope='Conv2d_0b_3x3')
          branch_1_camera = slim.conv2d(
              branch_1_camera, depth(96), [3, 3], stride=2, scope='Conv2d_1a_3x3')
        with tf.variable_scope('Branch_2'):
      ...
      with tf.variable_scope(end_point):
        ...
        with tf.variable_scope('Branch_1'):
          branch_1_gated = slim.conv2d(
              ...
              scope='Conv2d_0a_1x1')
          branch_1_gated = slim.conv2d(
              branch_1_gated, depth(96), [3, 3], scope='Conv2d_0b_3x3')
          branch_1_gated = slim.conv2d(
              branch_1_gated, depth(96), [3, 3], stride=2, scope='Conv2d_1a_3x3')
        with tf.variable_scope('Branch_2'):
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0_camera = slim.conv2d(net, depth(224), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
          branch_1_camera = slim.conv2d(
              net, depth(64), [1, 1],
              weights_initializer=trunc_normal(0.09),
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0_gated = slim.conv2d(net, depth(224), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
          branch_1_gated = slim.conv2d(
              net, depth(64), [1, 1],
              weights_initializer=trunc_normal(0.09),
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0_camera = slim.conv2d(net, depth(192), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
          branch_1_camera = slim.conv2d(
              net, depth(96), [1, 1],
              weights_initializer=trunc_normal(0.09),
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0_gated = slim.conv2d(net, depth(192), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
          branch_1_gated = slim.conv2d(
              net, depth(96), [1, 1],
              weights_initializer=trunc_normal(0.09),
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0_camera = slim.conv2d(net, depth(160), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
          branch_1_camera = slim.conv2d(
              net, depth(128), [1, 1],
              weights_initializer=trunc_normal(0.09),
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0_gated = slim.conv2d(net, depth(160), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
          branch_1_gated = slim.conv2d(
              net, depth(128), [1, 1],
              weights_initializer=trunc_normal(0.09),
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0_camera = slim.conv2d(net, depth(96), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
          branch_1_camera = slim.conv2d(
              net, depth(128), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_1_camera = slim.conv2d(branch_1_camera, depth(192), [3, 3],
                                 scope='Conv2d_0b_3x3')
        with tf.variable_scope('Branch_2'):
          branch_2_camera = slim.conv2d(
              net, depth(160), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_2_camera = slim.conv2d(branch_2_camera, depth(192), [3, 3],
                                 scope='Conv2d_0b_3x3')
          branch_2_camera = slim.conv2d(branch_2_camera, depth(192), [3, 3],
                                 scope='Conv2d_0c_3x3')
        with tf.variable_scope('Branch_3'):
      ...
      with tf.variable_scope(end_point):
        with tf.variable_scope('Branch_0'):
          branch_0_gated = slim.conv2d(net, depth(96), [1, 1], scope='Conv2d_0a_1x1')
        with tf.variable_scope('Branch_1'):
          branch_1_gated = slim.conv2d(
              net, depth(128), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_1_gated = slim.conv2d(branch_1_gated, depth(192), [3, 3],
                                 scope='Conv2d_0b_3x3')
        with tf.variable_scope('Branch_2'):
          branch_2_gated = slim.conv2d(
              net, depth(160), [1, 1],
              weights_initializer=trunc_normal(0.09),
              scope='Conv2d_0a_1x1')
          branch_2_gated = slim.conv2d(branch_2_gated, depth(192), [3, 3],
                                 scope='Conv2d_0b_3x3')
          branch_2_gated = slim.conv2d(branch_2_gated, depth(192), [3, 3],
                                 scope='Conv2d_0c_3x3')
        with tf.variable_scope('Branch_3'):
