...
def _create_losses(input_queue, create_model_fn, train_config):
  ...
  # changes
  prediction_dict = detection_model.predict(images, gated, true_image_shapes, true_gated_shapes)
  # changes
  losses_dict = detection_model.loss(prediction_dict, true_image_shapes, true_gated_shapes)
