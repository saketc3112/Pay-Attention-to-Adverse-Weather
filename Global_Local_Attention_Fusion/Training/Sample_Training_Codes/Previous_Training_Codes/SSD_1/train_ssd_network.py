...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        with tf.device(deploy_config.inputs_device()):
            ...
            #i = 0
            #while (i==0):
            #image1_tensor= image[0]
            #image1_numpy = image1_tensor.numpy()
            #image1_numpy.save("/home/saket/Dense/SSD/image/image_12.png", 'PNG')
            #print("All good")
            #i = 1
            ...
            #i = 0
            #while (i==0):
            #    tf.keras.preprocessing.image.save_img('/home/saket/Dense/image_1.png',image[0])
            #    print("All good")
            #    i = 1
