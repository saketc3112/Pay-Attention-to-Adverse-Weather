...
def _extract_predictions_and_losses(model,
  ...
  prediction_dict = model.predict(preprocessed_image,preprocessed_gated, true_image_shapes, true_gated_shapes)
  ...
  if not ignore_groundtruth:
    ...
    losses_dict.update(model.loss(prediction_dict, true_image_shapes, true_gated_shapes))
