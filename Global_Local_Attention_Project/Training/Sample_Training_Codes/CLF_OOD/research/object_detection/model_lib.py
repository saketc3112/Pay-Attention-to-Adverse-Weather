...
def create_model_fn(detection_model_fn, configs, hparams=None, use_tpu=False,
  ...
  def model_fn(features, labels, mode, params=None):
    ...
    # gated
    preprocessed_gated = features[fields.InputDataFields.gated]
    ...
    if use_tpu and train_config.use_bfloat16:
      with tf.tpu.bfloat16_scope():
        prediction_dict = detection_model.predict(
            preprocessed_images, preprocessed_gated,
            features[fields.InputDataFields.true_image_shape],
            features[fields.InputDataFields.true_gated_shape], **side_inputs)
    ...
    if mode in (tf.estimator.ModeKeys.TRAIN, tf.estimator.ModeKeys.EVAL):
      if (mode == tf.estimator.ModeKeys.EVAL and
        ...
        losses_dict = detection_model.loss(
            ...
            features[fields.InputDataFields.true_gated_shape])
