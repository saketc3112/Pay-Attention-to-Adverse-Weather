...
tf.app.flags.DEFINE_string(
    'data_dir', '/data/datasets/saket/SeeingThroughFogData/train_clear_day',
...
def input_pipeline(dataset_pattern='*.swedentfrecord', is_training=True, batch_size=FLAGS.batch_size):
    def input_fn():
...
def main(_):
    ...
    #config = tf.ConfigProto(log_device_placement=False, intra_op_parallelism_threads=FLAGS.num_cpu_threads, inter_op_parallelism_threads=FLAGS.num_cpu_threads, gpu_options=gpu_options)
    ...
    ssd_detector.train(input_fn=input_pipeline(dataset_pattern='*.swedentfrecord', is_training=True, batch_size=FLAGS.batch_size),
