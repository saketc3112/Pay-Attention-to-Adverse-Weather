...
def plot_image_projection(pointcloud, vtc, velodyne_to_camera, path_name, frame='default', title=None, saveto = "/home/saket/Dense/lidar_proj_2d.png"):
    ...
    if title is not None:
        plt.title(title)
    dpi = 200
    saveto = '/data/datasets/saket/SeeingThroughFogData/Lidar_Projections/L2C_' + path_name + '.png'
...
class SwedenImagesv2(ExampleCreator):
    ...
    def read_data(self, entry_id, total_id):
        ...
        for folder in self.point_keys:
            ...
            fig = plot_image_projection(lidar_data_last, vtc, velodyne_to_camera, path_name=velodyne_name)
