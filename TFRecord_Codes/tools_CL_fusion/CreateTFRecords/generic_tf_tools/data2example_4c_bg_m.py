...
class ExampleCreator(object):
    ...
    def process_fclass(self, parsed_labels):
        ...
        for idx,xm in enumerate(parsed_labels.difficults):
            ...
            if (parsed_labels.classes[idx] == b'Pedestrian' or parsed_labels.classes[idx] == b'person' or parsed_labels.classes[idx] == b'RidableVehicle'  or parsed_labels.classes[idx] == b'PassengerCar' or parsed_labels.classes[idx] == b'LargeVehicle' or parsed_labels.classes[idx] == b'train' or parsed_labels.classes[idx] == b'DontCare') and (xm == 1):
