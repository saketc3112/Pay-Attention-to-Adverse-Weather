...
class FasterRCNNFeatureExtractor(object):
  ...
  def extract_proposal_features(self, preprocessed_inputs,preprocessed_gated, scope):
    ...
    """
    with tf.variable_scope(scope, values=[preprocessed_inputs,preprocessed_gated]):
...
class FasterRCNNMetaArch(model.DetectionModel):
  ...
  def predict(self, preprocessed_inputs, preprocessed_gated, true_image_shapes, true_gated_shapes, **side_inputs):
    ...
    if self._number_of_stages >= 2:
      prediction_dict.update(
          self._predict_second_stage(
              ...
              true_image_shapes, true_gated_shapes,
              **side_inputs))
  ...
  def _predict_second_stage(self, rpn_box_encodings,
                            ...
                            true_image_shapes, true_gated_shapes, **side_inputs):
  ...
  def _predict_third_stage(self, prediction_dict, image_shapes, gated_shapes):
  ...
  def loss(self, prediction_dict, true_image_shapes, true_gated_shapes, scope=None):
